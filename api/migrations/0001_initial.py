# Generated by Django 5.1.5 on 2025-06-03 03:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuentaValidada', models.CharField(choices=[('PRO', 'Proveedor'), ('EMP', 'Empleado')], default='EMP', max_length=3)),
            ],
        ),
        migrations.CreateModel(
            name='Unidad',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(default='', max_length=300, unique=True)),
                ...
                ('categoria', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.categoria')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articulo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='imagenes', to='api.articulo')),
            ],
        ),
        migrations.CreateModel(
            name='Perfil',
            fields=[
                ...
                ('tipoCuenta', models.CharField(choices=[('CLI', 'Cliente'), ('PRO', 'Proveedor'), ('EMP', 'Empleado')], default='CLI', max_length=3)),
                ...
                ('numExt', models.CharField(blank=True, default='', max_length=50)),
                ('numInt', models.CharField(blank=True, default='', max_length=50)),
                ('colonia', models.CharField(blank=True, default='', max_length=300)),
                ('codigoPostal', models.PositiveIntegerField(default=None, null=True)),
                ...
                ('constanciaFiscal', models.FileField(blank=True, null=True, upload_to='constancias')),
